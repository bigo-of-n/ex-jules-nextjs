      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            shadcn/ui is configured, but components cannot be used due to missing dependencies.
          </p>
        </div>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Resolve environment issues to install dependencies and use shadcn/ui components.
          </p>
        </div>
